...
** a) **b04 models** (b04_RNA002, b04_RNA004 and b04_RNA002_tRNA) models are demuxing the same 20nt- barcodes as DeePlexiCon, listee [HERE](https://github.com/novoalab/SeqTagger/new/main/models/b04_RNA004/barcodes.fa). 
...
** b) **b96 models** (b96_RNA002 and b96_RNA004) are using the 37-nt barcodes, listed [HERE](https://github.com/novoalab/SeqTagger/new/main/models/b96_RNA004/barcodes.fa).

** c) **b07 models** (b07_RNA004_tRNA) are using a mix of 20nt and 37nt barcodes listed [HERE](https://github.com/novoalab/SeqTagger/new/main/models/b07_RNA004_tRNA/barcodes.fa).
