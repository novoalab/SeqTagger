...
**Please note:** These models do not work well on Nano-tRNAseq libraries. You can find SeqTagger Dockerfiles with pre-trained **tRNA** demultiplexing models [here](/models/b04_RNA002_tRNA) (for **RNA002** chemistries) and [here](https://www.immaginabiotech.com/product/nano-trnaseq) (for **RNA004** chemistries).
